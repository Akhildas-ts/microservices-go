...
const (
	AdminService_SignupAdmin_FullMethodName = "/admin.AdminService/SignupAdmin"
	AdminService_LoginAdmin_FullMethodName  = "/admin.AdminService/LoginAdmin"
	AdminService_Validate_FullMethodName    = "/admin.AdminService/Validate"
)
...
func (c *adminServiceClient) SignupAdmin(ctx context.Context, in *SignupAdminRequest, opts ...grpc.CallOption) (*SignupAdminResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignupAdminResponse)
	err := c.cc.Invoke(ctx, AdminService_SignupAdmin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAdminServiceServer) SignupAdmin(context.Context, *SignupAdminRequest) (*SignupAdminResponse, error) {
...
func _AdminService_SignupAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignupAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).SignupAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_SignupAdmin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).SignupAdmin(ctx, req.(*SignupAdminRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AdminService_SignupAdmin_Handler,
		},
		{
